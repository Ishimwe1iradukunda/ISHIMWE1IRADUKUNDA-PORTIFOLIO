...
const testimonials = [
  {
    ...
    avatar: "SJ",
    text: "Alex is one of the most talented engineers I've had the pleasure of working with. Their ability to architect scalable systems while keeping code clean and maintainable is exceptional. They delivered our analytics platform months ahead of schedule.",
    rating: 5,
  },
  {
    ...
    avatar: "MW",
    text: "Hiring Alex was the best decision we made for our startup. They took full ownership of our backend architecture and frontend — and the results speak for themselves. Our user retention improved by 40% after their UX overhaul.",
    rating: 5,
  },
  {
    name: "Emily Chen",
    ...
    avatar: "EC",
    text: "Alex consistently delivered high-quality work under tight deadlines. Their communication was always clear, and they proactively flagged risks before they became problems. A true professional and a great team player.",
    rating: 5,
  },
  {
    name: "David Park",
    ...
    avatar: "DP",
    text: "Alex's contributions to our open-source CI/CD tool were game-changing. The architecture they proposed reduced our build times by 80%. If you need someone who can think at scale, Alex is your person.",
    rating: 5,
  },
];
